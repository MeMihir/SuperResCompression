...
tf.compat.v1.flags.DEFINE_string('image', None, 'Location of image to compress.')
tf.compat.v1.flags.DEFINE_integer('quality', 8, 'Compression level.'
                        'Must be between 0 and 15 inclusive.')
tf.compat.v1.flags.DEFINE_string('model', 'google\'s-compression-model/residual_gru.pb',
...
########### decoding
        ...
        print('[{}] [INFO]         saving \'{}\''.format(time.strftime('%H:%M:%S')),os.path.basename(out_path))
